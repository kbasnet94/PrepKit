...
│   └── survival-app/       # PrepKit - Expo React Native survival app
...
**PrepKit** — An offline-first survival/emergency preparedness mobile app for iOS and Android built with Expo React Native.
