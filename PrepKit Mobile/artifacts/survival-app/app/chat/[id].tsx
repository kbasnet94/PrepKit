...
export default function ChatDetailScreen() {
  ...
  const handleExport = async () => {
    ...
    const sessionTitle = currentSession?.title || "PrepKit Chat";
    ...
    lines.push(`PrepKit — offline-first emergency preparedness`);

    const text = lines.join("\n");
    const filename = `prepkit-chat-${Date.now()}.txt`;
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.emptyChat}>
              ...
              <Text style={styles.emptyChatTitle}>PrepKit Assistant</Text>
