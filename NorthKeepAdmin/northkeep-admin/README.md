...
The “Generate bundle” action in NorthKeepAdmin returns the same structure you can host or upload; you can add a public API route or Storage bucket that serves the latest manifest and bundle to the app.
