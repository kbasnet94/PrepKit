    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-muted-foreground text-sm">{list.length} version(s)</p>
        </CardHeader>
        <CardContent>
          {list.length === 0 ? (
